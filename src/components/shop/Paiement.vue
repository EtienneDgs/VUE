    ...
    <div id="corpse">
        ...
        <template v-if="authenticated">  
                            ...
                            <div v-if="this.numberCoin == 0">
                                 <p>Prêt à acheter des tokens, <span class="highlighted">{{user.name}}</span> ?</p>
...
<style>
      #paiement{
        ...
        -webkit-box-shadow: inset 10px 10px 33px -22px rgba(0,0,0,0.36);
        -moz-box-shadow: inset 10px 10px 33px -22px rgba(0,0,0,0.36);
        box-shadow: inset 10px 10px 33px -22px rgba(0,0,0,0.36);
